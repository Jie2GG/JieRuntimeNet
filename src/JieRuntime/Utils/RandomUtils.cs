...
namespace JieRuntime.Utils
{
    ...
    public static class RandomUtils
    {
        ...
        public static ushort RandomUInt16 (ushort minValue = ushort.MinValue, ushort maxValue = ushort.MaxValue)
        {
        ...
        {
            return BinaryConvert.ToUInt32 (BinaryConvert.GetBytes (RandomInt32 (int.MinValue)));
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="minValue"/> 大于 <paramref name="maxValue"/></exception>
        public static int RandomInt32 (int minValue = 0, int maxValue = int.MaxValue)
        {
        ...
        {
            return BinaryConvert.ToUInt64 (BinaryConvert.GetBytes (RandomInt64 (long.MinValue)));
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="minValue"/> 大于 <paramref name="maxValue"/></exception>
        public static long RandomInt64 (long minValue = 0L, long maxValue = long.MaxValue)
        {
