...
namespace JieRuntime.Windows.Structs
{
    ...
    public struct SizeT : IEquatable<SizeT>, IComparable<SizeT>, IConvertible, IComparable
    {
        ...
        public SizeT (uint value) => this.val = (UIntPtr)value;

        /// <summary>Initializes a new instance of the <see cref="SizeT"/> struct.</summary>
        /// <param name="value">The value.</param>
        public SizeT (ulong value) => this.val = new UIntPtr (value);
        ...
        public ulong Value { get => this.val.ToUInt64 (); private set => this.val = new UIntPtr (value); }
        ...
        /// <inheritdoc/>
        public int CompareTo (SizeT other) => this.Value.CompareTo (other.Value);

        /// <inheritdoc/>
        public override bool Equals (object obj) => obj is SizeT s ? this.Equals (s) : this.Value.Equals (obj);

        /// <inheritdoc/>
        public bool Equals (SizeT other) => this.Value.Equals (other.Value);
        ...
        /// <inheritdoc/>
        int IComparable.CompareTo (object obj) => this.Value.CompareTo (Convert.ChangeType (obj, typeof (ulong)));
        ...
        /// <inheritdoc/>
        ulong IConvertible.ToUInt64 (IFormatProvider provider) => this.Value;
