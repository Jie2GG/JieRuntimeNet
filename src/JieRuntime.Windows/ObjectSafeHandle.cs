...
{
    /// <summary>
    /// 表示可以用 CloseHandle 关闭的 Win32 句柄
    /// </summary>
    public class ObjectSafeHandle : SafeHandle
    {
        #region --字段--
        /// <summary>
        /// 表示 Win32 的无效句柄 <see cref="Kernel32.INVALID_HANDLE_VALUE"/>.
        /// </summary>
        public static readonly ObjectSafeHandle Invalid = new ();

        /// <summary>
        /// 表示 Win32 null 的句柄 <see cref="IntPtr.Zero"/>.
        /// </summary>
        public static readonly ObjectSafeHandle Null = new (IntPtr.Zero, false);
        #endregion
        ...
        /// <exception cref="TypeLoadException">派生类驻留在没有非托管代码访问权限的程序集中</exception>
        public ObjectSafeHandle (IntPtr preexistingHandle, bool ownsHandle = true)
        ...
        protected override bool ReleaseHandle () => Kernel32.CloseHandle (this.handle);
        #endregion
    }
}
